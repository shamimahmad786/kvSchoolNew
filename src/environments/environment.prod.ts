export const environment = {
  ...
  BASE_URL_DATA_USER:'http://localhost:8090/meuser/api/user/',
  BASE_URL_DATA_SURPLUS_TRANSFER:'http://localhost:8015/api/transfer/',
  LOGOUT_URL:'http://localhost:8385/meauth/logout?returnTo=http://10.25.26.10:4200/',
  LOGIN_URL_INDIVIDUAL:'http://localhost:8385/meauth/oauth/authorize?response_type=code&user_oauth_approval=true&client_id=teacher&redirect_uri=http://10.25.26.10:4200/teacher/profile&scopes=read',
  ...
  AUTH_GUARD_HREF1:'http://localhost:8385/meauth/logout?returnTo=http://10.25.26.10:4200/',
  BASE_URL_MEUSER:'http://localhost:8090/meuser/api/user/',
